...
import cybersecurityserver.email.SendSMTP;
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(12, 12, 12)
                        .addComponent(lblMessage, javax.swing.GroupLayout.DEFAULT_SIZE, 373, Short.MAX_VALUE))
    ...
    void loginAction() {
        ...
        if (objBean == null) {
            ...
            if (objBean.getUserStatus().equalsIgnoreCase("inactive")) {
                ...
                MainFrame objFrame = new MainFrame(objBean, userActivityID);
                setVisible(false);
            }
        }
